...
export default function App() {
  ...
  return (
    <main className="grid min-h-screen place-items-center bg-[radial-gradient(circle_at_top,rgba(234,179,8,0.22),transparent_30%),linear-gradient(160deg,#111827_0%,#172033_55%,#0f172a_100%)] px-6 py-10 text-stone-100">
      <section className="w-full max-w-2xl rounded-[28px] border border-white/12 bg-slate-950/70 p-8 shadow-[0_24px_80px_rgba(15,23,42,0.38)] backdrop-blur-xl sm:p-10 flex flex-col gap-5">
        ...
        >
          ...
          <div className="flex flex-row justify-between items-center gap-4">
            ...
            />
            <button
              className=" rounded-full bg-amber-400 px-4 py-2 cursor-pointer text-black font-bold"
